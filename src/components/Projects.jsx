    ...
    return (
      ...
      <Col xs={6} md={3}>
        <Link to='/byte-size-habits' className='recent-projects-link'> <h2 className='projects-title'>Byte Size Habits</h2></Link>
          <p className="projects-text">Byte Size Habits is a habit tracker web application specifically designed to help users learn how to code and improve their programming skills.</p>
      ...
      <Col id='borderline-text-box'xs={12} md={3}>
          <Link to='/borderline-arts' className='recent-projects-link'><h2 id='borderline-header' className='projects-title'>Borderline Arts</h2></Link>
