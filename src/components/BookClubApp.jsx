...
<br></br>User engagement is encouraged through access to group messaging, polls for future book club picks and awards for book club participation and completing reading challenges. 
          ...
          <ul>
              ...
              <li className="byte-size-list"><h5 className="byte-size-list"><span><strong>Simplify and facilitate. </strong> This app provides group messaging for book clubs to promote book discussions and tools such as polls to plan future meetings. 
              </span></h5></li>
              <li className="byte-size-list"><h5 className="byte-size-list"><span><strong>Encourage user engagement.</strong> Your Book Club not only provides a connection to a community of book lovers it also rewards users with profile badges and incentives for their participation in book clubs and the completion of reading challenges. 
              </span></h5></li>
            </ul>
            </Col>
          </Row>
          ...
          <ul>
              <li className="byte-size-list"><h5 className="byte-size-list"><span><strong>Name: </strong> Charlotte Hughes</span></h5></li>
              <li className="byte-size-list"><h5 className="byte-size-list"><span><strong>Age: </strong>35</span></h5></li>
              <li className="byte-size-list"><h5 className="byte-size-list"><span><strong>Occupation: </strong>Marketing Manager</span></h5></li>
              <li className="byte-size-list"><h5 className="byte-size-list"><span><strong>Location: </strong>Birmingham</span></h5></li>
              <li className="byte-size-list"><h5 className="byte-size-list"><span><strong>Device: </strong>Android (Pixel 6)</span></h5></li>
              <li className="byte-size-list"><h5 className="byte-size-list"><span><strong>Desired Outcome: </strong>Meet new people and increase personal reading goals.</span></h5></li>
              <li className="byte-size-list"><h5 className="byte-size-list"><span><strong>Strengths: </strong>Intelligent, professional and open-minded.</span></h5></li>
